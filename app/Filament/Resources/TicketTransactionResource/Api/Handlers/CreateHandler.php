...
class CreateHandler extends Handlers {
    ...
    public function handler(CreateTicketTransactionRequest $request)
    {
        ...
        try {
            ...
            $model->snap_token = $snapToken;
            
            // Generate QR code after successful transaction creation
            $qrCodePath = QRCodeService::generateTicketQR($model);
            $model->qr_code_path = $qrCodePath;
